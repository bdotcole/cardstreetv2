...
/**
 * The VIEWER. Whatnot-style layout: two stacked feeds (face cam ~40% top,
 * table cam ~60% bottom, tap the top feed to swap which camera is primary),
 * chat overlaying the lower feed, and the spot board as a slide-up sheet.
...
export default function LiveViewerPage() {
    ...
    const [primarySlot, setPrimarySlot] = useState<CameraSlot>('table');
