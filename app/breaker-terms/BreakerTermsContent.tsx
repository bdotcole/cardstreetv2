...
const TH: BreakerTermsData = {
  ...
  sections: [
      ...
      blocks: [
        {
          ...
          body: 'ต้องใช้สินค้าของแท้เท่านั้นในการเปิดหรือขาย ห้ามสินค้าปลอม พร็อกซี ของทำซ้ำ ของที่ถูกซีลใหม่ หรือถูกดัดแปลงโดยเด็ดขาด เช่นเดียวกับทุกส่วนของ Cardstreet และต้องอธิบายสิ่งที่คุณกำลังเปิดตามจริง ทั้งชุดการ์ด ประเภทสินค้า และจำนวนซองต่อสล็อต',
        },
        {
          label: 'ทำตามรูปแบบที่ประกาศไว้:',
          body: 'Cardstreet Live รองรับรูปแบบ break เฉพาะบางรูปแบบ (เช่น personal break, pick your pack, random pack, chase break และ pack wars) คุณต้องจัดตามรูปแบบ สินค้า จำนวนสล็อต และราคาที่ประกาศไว้ ห้ามเปลี่ยนเงื่อนไขของ break หลังจากมีการขายสล็อตไปแล้ว',
        },
        {
    ...
    {
      heading: '7. สล็อต ค่าธรรมเนียม และการชำระเงิน',
      blocks: [
        {
          label: 'ผู้ซื้อจ่ายเป็นรายสล็อต:',
          body: 'สล็อตจะถูกขายผ่านระบบชำระเงินของ Cardstreet ระหว่างไลฟ์ และรับชำระผ่านแพลตฟอร์มเท่านั้น ห้ามชักชวนหรือรับชำระเงินค่า break นอกระบบ Cardstreet',
        },
        {
        ...
        {
          label: 'ราคาสล็อตไม่รวมค่าจัดส่ง:',
          body: 'ราคาสล็อตไม่มีค่าจัดส่งรวมอยู่ ค่าจัดส่งจะเรียกเก็บจากผู้ซื้อแยกต่างหากหลังจบไลฟ์ (ดูข้อ 8) จึงห้ามโฆษณาว่าราคาสล็อตรวมค่าส่งแล้ว',
        },
        {
          label: 'สล็อตที่ยกเลิกหรือขายไม่หมด:',
          body: 'สล็อตที่ขายไม่ออกยังเป็นของคุณ และซองที่ถูกจ่ายให้สล็อตนั้นจะยังคงอยู่ในบันทึก หาก break ไม่สามารถจัดได้ตามที่ประกาศไว้ ต้องคืนเงินค่าสล็อตทั้งหมด',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          body: 'คุณออกจากโปรแกรมเมื่อใดก็ได้ แต่ภาระที่คุณมีต่อผู้ซื้ออยู่แล้วยังคงอยู่ break ที่ขายสล็อตไปแล้วต้องจัดให้เสร็จ ปิดยอด และจัดส่ง หรือคืนเงิน',
        },
      ],
    },
    {
