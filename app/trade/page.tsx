      ...
      {loading ? (
        ...
        <div className="min-h-[60vh] flex items-center justify-center">
          <div className="w-full max-w-[400px] glass rounded-[2rem] border-white/10 p-8 text-center">
            ...
            <h1 className="text-2xl font-black tracking-tight uppercase italic skew-x-[-10deg]">Trade Finder</h1>
            <p className="text-sm text-slate-400 mt-3 leading-relaxed">
              Tag cards for trade, scan a friend's code, and get value-balanced trade proposals matched against both collections.
            </p>
            <a href="/premium" className="mt-6 block rounded-2xl bg-brand-cyan/10 border border-brand-cyan/20 p-4 active:scale-95 transition-all">
              ...
              <p className="text-xs text-slate-300 mt-2 leading-snug">Trade Finder is part of CardStreet Pro. Tap to learn more.</p>
            </a>
          </div>
        </div>
      )}
